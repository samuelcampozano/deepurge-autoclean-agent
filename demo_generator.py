...
'''
    ...
    def generate_file(self, category: str, index: int) -> Optional[Path]:
        ...
        try:
            ...
            print(f"{Fore.RED}❌ Failed to create {filename}: {e}{Style.RESET_ALL}")
            return None
    ...
    def generate_files(self, count: int = 50) -> list:
        ...
        print(f"\n{Fore.CYAN}🎬 DEEPURGE DEMO FILE GENERATOR{Style.RESET_ALL}")
        ...
        print(f"{Fore.YELLOW}📁 Generating test files...{Style.RESET_ALL}\n")
        ...
        print(f"\n{Fore.YELLOW}💡 Tip: Run the Deepurge Agent to organize these files:{Style.RESET_ALL}")
...
{Fore.CYAN}╔════════════════════════════════════════════════════╗
║                                                      ║
║   {Fore.WHITE}DEEPURGE AUTOCLEAN AGENT{Fore.CYAN}                         ║
║   {Fore.YELLOW}Demo File Generator{Fore.CYAN}                              ║
║                                                      ║
║   {Fore.GREEN}👤 Author: Samuel Campozano Lopez{Fore.CYAN}                ║
║   {Fore.MAGENTA}🎯 Sui Hackathon 2026{Fore.CYAN}                           ║
║                                                      ║
╚════════════════════════════════════════════════════╝{Style.RESET_ALL}
""")
    ...
    print(f"\n{Fore.GREEN}🎉 {len(files)} demo files created in {target_folder}{Style.RESET_ALL}")
